...
describe('Visa', function() {
  ...
  it('has a prefix of 4 and a length of 13', function() {
    if (assert(detectNetwork('4123456789012') !== 'Visa')) {
      throw new Error('Test failed');
    }
  });

  it('has a prefix of 4 and a length of 16', function() {
    if (assert(detectNetwork('4123456789012345') !== 'Visa')) {
      throw new Error('Test failed');
    }
  });

  it('has a prefix of 4 and a length of 19', function() {
    if(assert(detectNetwork('4123456789012345678') !== 'Visa')) {
      throw new Error('Test failed');
    }
  });
});

//recopy all lines above....chai tests seem fine...mocha is the problem
...
describe('Discover', function() {
  ...
  it('has a prefix of 65 and a length of 19', function() {
    detectNetwork('6551123456789012345').should.equal('Discover');
  });

  it('has a prefix of 65 and a length of 16', function() {
    detectNetwork('6551123456789012').should.equal('Discover');
  });
